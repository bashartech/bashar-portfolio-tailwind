...
//       <div className="hero w-full bg-bgColor flex flex-col lg:flex-row justify-center items-center min-h-screen py-10 px-4 lg:px-8" id="/">
//         <div className="heroContent w-full max-w-6xl flex flex-col lg:flex-row justify-around items-center">
//           <div className="text w-full lg:w-1/2 mt-10 lg:mt-0 flex justify-center">
//             <div className="content w-full max-w-lg">
//               <h3 className="text-text text-2xl sm:text-3xl font-bold mb-2">
//                 Hello, It's Me
//               </h3>
//               <h1 className="text-text text-4xl sm:text-5xl font-bold mb-2">M.Bashar</h1>
//               <h3 className="text-text text-2xl sm:text-3xl font-bold mb-4">
//                 And I am a <span className="text-main multiple-text" ref={typedElement}></span>
//               </h3>
//               <p className="text-text text-base sm:text-lg mb-6">
//                 We create dynamic websites and captivating visuals and videos to
//                 engage large audience effectively
//               </p>
//               <div className="social-media flex mb-6">
//                 {['facebook-circle', 'linkedin', 'instagram-alt', 'gmail'].map((icon, index) => (
//                   <Link
//                     key={icon}
//                     className="flex justify-center items-center w-10 h-10 bg-transparent border border-main hover:bg-main hover:text-bgColor rounded-full text-xl text-main mr-3 transition-colors duration-300"
//                     href="#"
//                   >
...
//                 <Link
//                   href="cv.jpg"
//                   className="inline-block px-6 py-3 bg-main text-bgColor hover:bg-opacity-80 rounded-full transition-colors duration-300"
//                 >
//                   Check CV
//                 </Link>
//               </div>
//             </div>
//           </div>
//           <div className="img w-full lg:w-1/2 mt-10 lg:mt-0 flex justify-center">
//             <img className="w-full max-w-md" src="/images/img1.png" alt="Profile" />
//           </div>
//         </div>
//       </div>
//     </>
...
//                 {['github', 'linkedin', 'instagram-alt', 'gmail'].map((icon, index) => (
//                   <Link
//                     key={icon}
...
//                 <Link
//                   href="cv.jpg"
//                   className="inline-block px-6 py-3 bg-main text-bgColor hover:bg-opacity-80 rounded-full transition-all duration-300 transform hover:scale-105 hover:shadow-lg"
//                 >
//                   Check CV
//                 </Link>
//               </div>

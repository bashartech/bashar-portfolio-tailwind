...
//               <div className="aspect-w-16 sm:h-[50px] aspect-h-9">
//                 <img
...
//                   />
//               </div>
//               <div className="absolute inset-0 w-full h-full object-cover  bg-gray-900 bg-opacity-75 flex flex-col justify-center items-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-4">

...
//   return (
//     <div id="portfolio" className="w-full min-h-screen bg-second bg-gradient-to-b from-second to-bgColor py-16 px-4 overflow-hidden">
//       <div className="max-w-6xl mx-auto">
//         <h2 className="text-main text-3xl sm:text-4xl font-bold text-center mb-12 animate-slideInDown">
//           Latest Projects
//         </h2>
...
//           {projects.map((project, index) => (
//             <div key={index} 
//                  className="bg-bgColor rounded-xl overflow-hidden group relative lg:h-56 shadow-lg transform hover:scale-105 transition-all duration-300 animate-fadeIn"
...
//                 />
//               </div>
//               <div className="absolute inset-0 bg-gray-900 bg-opacity-75 flex flex-col justify-center items-center opacity-0 group-hover:opacity-100 transition-all duration-300 p-4">
//                 <h4 className="text-white text-lg font-semibold mb-2">{project.h4}</h4>
//                 <p className="text-white text-sm text-center px-4 mb-4">{project.p}</p>
//                 <a
//                   href={project.link}
//                   className="text-white text-2xl hover:text-main transition-colors duration-300 transform hover:scale-110"
//                   target="_blank"
//                   rel="noopener noreferrer"
//                 >
//                   <i className="bx bx-link-external"></i>

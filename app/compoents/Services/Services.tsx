...
//   return (
//     <div id="services" className="w-full min-h-screen bg-bgColor py-16 px-4">
...
//             },
//           ].map((service, index) => (
//             <div key={index} className="bg-second text-white p-6 rounded-xl hover:border-2 hover:border-main transition-all duration-300">
//               <div className="mb-6 flex justify-center">
//                 <i className={`bx ${service.icon} text-5xl text-main`}></i>
//               </div>
//               <h3 className="text-xl font-bold text-center mb-4">{service.title}</h3>
//               <p className="text-center mb-6">{service.description}</p>
//               <div className="flex justify-center">
//               <Link href={"/services"}> <button className="px-6 py-2 bg-main text-bgColor rounded-full hover:bg-opacity-80 transition-colors duration-300">
//                   Learn More
//                 </button></Link>  
//               </div>
//             </div>
